...
import com.vela.data.model.SeerrConnectionInfo
import com.vela.data.model.SeerrRequestedItem
import com.vela.data.model.SeerrUserRequestLimits
import com.vela.data.repository.SeerrRepository
import com.vela.data.repository.SeerrHostnameAlreadyConfiguredException
import com.vela.data.repository.SeerrSessionExpiredException
        ...
        viewModelScope.launch {
            ...
            if (scopeId.isNullOrBlank()) {
                val result = Result.failure<SeerrConnectionInfo>(
                    Exception("No active Vela session is available.")
                )
                setSeerrState(
                    SeerrUiState(
