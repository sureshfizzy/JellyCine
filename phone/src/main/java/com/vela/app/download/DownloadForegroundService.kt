...
class DownloadForegroundService : Service() {
    ...
    private fun fallbackNotification(): Notification {
        return Notification.Builder(this, DownloadNotificationContract.CHANNEL_ID)
            .setSmallIcon(com.vela.shared.R.mipmap.ic_launcher)
            .setContentTitle(getString(com.vela.shared.R.string.downloads_notification_preparing))
            .setContentText(getString(com.vela.shared.R.string.downloads_notification_syncing_state))
            .setOngoing(true)
            .build()
    }

    companion object {
        private const val ACTION_START = "com.vela.app.download.FGS_START"
        private const val ACTION_STOP = "com.vela.app.download.FGS_STOP"
